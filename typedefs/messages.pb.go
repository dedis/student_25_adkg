...
type SSMessage_ShareInst struct {
	ShareInst *SSMessage_Share `protobuf:"bytes,3,opt,name=share_inst,json=shareInst,proto3,oneof"`
}

type SSMessage_ReconstructInst struct {
	ReconstructInst *SSMessage_Reconstruct `protobuf:"bytes,4,opt,name=reconstruct_inst,json=reconstructInst,proto3,oneof"`
}
...
func (x *SSMessage_Reconstruct) GetIdx() int64 {
	if x != nil {
		return x.Idx
	}
	return 0
...
const file_messages_proto_rawDesc = "" +
	...
	"\x02si\x18\x01 \x01(\fR\x02si\x12\x0e\n" +
	"\x02ri\x18\x02 \x01(\fR\x02ri\x12\x10\n" +
	"\x03idx\x18\x03 \x01(\x03R\x03idxB\x04\n" +
	"\x02op\"\x8a\x01\n" +
	"\x06Packet\x126\n" +
	"\n" +
	"rbcMessage\x18\x01 \x01(\v2\x14.typedefs.RBCMessageH\x00R\n" +
	"rbcMessage\x12=\n" +
	"\x0fss_message_inst\x18\x02 \x01(\v2\x13.typedefs.SSMessageH\x00R\rssMessageInstB\t\n" +
	"\amessageB\fZ\n" +
	"./typedefsb\x06proto3"
...
var file_messages_proto_goTypes = []any{
	...
	(*Packet)(nil),                // 2: typedefs.Packet
	(*RBCMessage_Propose)(nil),    // 3: typedefs.RBCMessage.Propose
	(*RBCMessage_Echo)(nil),       // 4: typedefs.RBCMessage.Echo
	(*RBCMessage_Ready)(nil),      // 5: typedefs.RBCMessage.Ready
	(*SSMessage_Share)(nil),       // 6: typedefs.SSMessage.Share
	(*SSMessage_Reconstruct)(nil), // 7: typedefs.SSMessage.Reconstruct
}
var file_messages_proto_depIdxs = []int32{
	3, // 0: typedefs.RBCMessage.propose_inst:type_name -> typedefs.RBCMessage.Propose
	4, // 1: typedefs.RBCMessage.echo_inst:type_name -> typedefs.RBCMessage.Echo
	5, // 2: typedefs.RBCMessage.ready_inst:type_name -> typedefs.RBCMessage.Ready
	6, // 3: typedefs.SSMessage.share_inst:type_name -> typedefs.SSMessage.Share
	7, // 4: typedefs.SSMessage.reconstruct_inst:type_name -> typedefs.SSMessage.Reconstruct
	0, // 5: typedefs.Packet.rbcMessage:type_name -> typedefs.RBCMessage
	1, // 6: typedefs.Packet.ss_message_inst:type_name -> typedefs.SSMessage
