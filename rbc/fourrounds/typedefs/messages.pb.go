...
func (x *Message_Echo) GetMessageHash() []byte {
	if x != nil {
...
func (x *Message_Ready) GetEncodingShare() []byte {
	if x != nil {
		return x.EncodingShare
	}
	return nil
...
func (x *Message_Ready) GetMessageHash() []byte {
	if x != nil {
		return x.MessageHash
	}
	return nil
...
func (x *Message_Ready) GetIndex() int64 {
	if x != nil {
		return x.Index
	}
	return 0
